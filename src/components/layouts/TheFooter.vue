    ...
    <div class="container">
      <div class="row footer-top">
        <div class="col-sm-5 col-lg-5">
          ...
          <div class="text-md">
            <a v-for="(item,index) in contacts" :key="index" :title="item.title" :href="item.link" :style="contactStyle" target="_blank">
          ...
          <div class="row">
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="(item,key) in sponsor.list" :key="key">
            ...
            <div class="col-sm-4">
              ...
              <ul class="list-unstyled">
                <li v-for="(item,key) in other.list" :key="key">
